...
namespace dials { namespace algorithms {
  ...
  /**
   * A class to do ToF reflection prediction.
   * Uses TOFRayPredictor to make predictions, and adds additional
  ...
  protected:
     ...
     * @param panel The panel index
     */
    virtual void append_for_index(tof_prediction_data &p,
                                  const mat3<double> ub,
                                  const miller_index &h,
                                  int panel = -1) {
      Ray ray;
