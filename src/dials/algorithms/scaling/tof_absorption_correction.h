...
#ifndef DIALS_ALGORITHMS_SCALING_TOF_ABSORPTION_CORRECTION_H
#define DIALS_ALGORITHMS_SCALING_TOF_ABSORPTION_CORRECTION_H
...
#endif /* DIALS_ALGORITHMS_SCALING_TOF_ABSORPTION_CORRECTION_H */